...
import selectGameOptions from "../../../../../store/deckit/selectors/selectGameOptions";
/**
 * TODO:
...
const Deckit = () => {
  ...
  const gameOptions = useSelector(selectGameOptions);
  // const get
  return (
    <div className={styles.table}>
      <StyledHinter>
        {activeRoom && userId === activeRoom.hinter
          ...
          : `${
              gameOptions.hinter ? gameOptions.hinter.username : ""
            } is choosing a hint`}
      </StyledHinter>
      <div className={styles.draft}></div>
      {activeRoom && userId === gameOptions.hinter && (
        <Formik
          initialValues={{
            hint: ""
          }}
